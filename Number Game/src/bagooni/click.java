...
class MainFrame extends JFrame implements MouseListener, Runnable {
	...
	public void TimeCheck() {
		if (time_run) {
			...
			actual_time = current_time - start_time;//게임시작버튼을눌렀을때의시간값과 실제시간값으로게임진행시간계산.
...
class ImagePanel extends JPanel implements MouseListener {//실제게임화면을표시할패널
	...
	public void gameStart(boolean game_start) {//게임기본세팅 25개의사각박스와해당박스안에 랜덤으로난수를발생시켜나온숫자를받아입력한다.
